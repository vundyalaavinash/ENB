...
/**
 *<p>
 * Title: ValidateEmail class - A component of the ENB Tool
 * </p>
 * <p>
 * Description: It is an entity class which is used to check whether the email is valid 
 * </p>
 * @author Avinash
 */
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(rh.ValidateUser(email)!=null){
                out.print("Yes"); // if email is valid
            }
            else{
                out.print("No");   // if email is invalid
            }
        } finally {            
            out.close();
        }
